...
const displayStr = `A total of $${GAMES_JSON.filter( (game) => game.pledged).reduce( (acc, game) => acc + game.pledged, 0).toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
...
console.log(topGame.name + " | " + runnerUpGame.name);
